(function () {
  ...
  const LABEL_Y = 140;           // label baseline inside the card (in viewBox units)
  const RECT_Y = 20;             // top offset inside the group
  const RECT_H = 360;            // card height (in viewBox units) ~almost full height
